...
#working on in my free time. What this does is it extracts various features/
#information from a video's transcript (extracted before-hand), and then it stores
#the extracted features into a nosql database (AWS DynamoDB in this case).
import numpy as np
import boto3
import ast
import json
